...
<html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <script data-main="js/main" src="{{asset('static/game/bunengsi/js/require.js')}}"></script>
    <title>一个都不能死</title>
    <style type="text/css">
        body{
            margin:0px;
    ...
    <script type="text/javascript" charset="utf-8" async="" data-requirecontext="_" data-requiremodule="main" src="{{asset('static/game/bunengsi/js/main.js')}}"></script></head>
<body>
...
<div id="share" style="display:none">
    <img id="logo" width="100%" src="{{asset('static/game/bunengsi/images/460.jpg')}}" style="position:absolute;top:0;left:0;">
    <img width="100%" src="{{asset('static/game/bunengsi/images/2000.jpg')}}" style="position:absolute;top:0;left:0;display:" onClick="document.getElementById(&#39;share&#39;).style.display=&#39;none&#39;;">
</div>
</body></html>